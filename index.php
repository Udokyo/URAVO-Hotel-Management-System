    ...
    <div class="modal-dialog modal-md" role="document">
      ...
      <div class="modal-footer">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Hotel Mangement system | <a href="..\Hotel_Booking_Management_System\index.php" target="_blank">URAVO</a></div></div>
        </footer>
